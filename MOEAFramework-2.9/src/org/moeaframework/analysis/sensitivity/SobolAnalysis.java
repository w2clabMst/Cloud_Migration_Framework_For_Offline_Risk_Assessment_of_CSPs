...
public class SobolAnalysis extends CommandLineUtility {
	...
	public void run(CommandLine commandLine) throws Exception {
		...
		parameterFile = new ParameterFile(new File("Params.txt"));
		...
		File input = new File("C:\\Users\\asrp6\\Google Drive\\Workspace\\MOEAFramework-2.9\\examples\\org\\moeaframework\\examples\\ga\\cloudMigration\\objectiveValues.txt");
		N = validate(input);
		load(input);
